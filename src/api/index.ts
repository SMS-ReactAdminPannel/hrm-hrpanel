  ...
  hr = {
    ...
    asset: {
      ...
      updateasset: (assetId: string, data: any) =>
        httpClient.patch(API_END_POINTS.asset.updateAsset(assetId), data),
    ...
    departments: {
      ...
      getDepartmentById: (id: string) =>
        httpClient.get(API_END_POINTS.department.getById(id)),
    ...
    payroll: {
      createPayroll: (data: any) =>
        httpClient.post(API_END_POINTS.payroll.create, data),

      getPayrollById: (payrollId: string) =>
        httpClient.get(API_END_POINTS.payroll.getOne(payrollId)),

      updatePayroll: (payrollId: string, data: any) =>
        httpClient.put(API_END_POINTS.payroll.update(payrollId), data),

      deletePayroll: (payrollId: string) =>
        httpClient.delete(API_END_POINTS.payroll.delete(payrollId)),

      getAllPayrolls: () =>
        httpClient.get(API_END_POINTS.payroll.getAll),
    },
  };
}

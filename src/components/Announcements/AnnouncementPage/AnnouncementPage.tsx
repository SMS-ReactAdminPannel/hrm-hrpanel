...
const Announcement = () => {
  ...
  return (
    <div
      ...
      <section className=" flex items-center gap-6 mb-4 flex-wrap ">
        ...
        {/* button */}
          ...
          <div>
            <button
              ...
              className="relative inline-flex items-center justify-center px-6 py-2.5 overflow-hidden tracking-tighter text-white bg-[#3e3a85]  rounded-md group hover:scale-104"
            >

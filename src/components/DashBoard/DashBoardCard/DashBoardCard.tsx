...
const Dashboardcard = () => {
  return (
    <div className="flex flec-cols justify-between mt-6 bg-white rounded-xl  flex-1 p-2 text-[#006666]   ">
      <div className="grid grid-cols-2   flex-2.5 ">
        <div className="  flex-1/4 border-r-2 border-b-2  p-5  ">
          <div className="p-3 ">
            <div className="mb-3">
        ...
        <div className="flex-1/4  border-b-2 p-5  ">
          <div className="p-3 ">
            <div className="mb-3">
        ...
        <div className="flex-1/4  p-5 border-r-2  ">
          <div className=" p-3">
            <div className="mb-3">

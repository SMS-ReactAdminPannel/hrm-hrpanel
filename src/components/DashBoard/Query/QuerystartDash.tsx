    ...
    <div className="rounded-2xl p-6 shadow-sm h-full bg-transparent">
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div>
          ...
          <p
            className="text-sm mt-4 mx-2 !text-white"
      ...
      <div className="flex flex-col h-full gap-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col items-center">
            <div className="shadow-md bg-gray-200 border w-32 h-32 rounded-xl flex flex-col items-center justify-center ml-20">
              ...
              <div style={{...FONTS.description}} className="text-sm !text-gray-700 mt-1">Total Queries</div>
            </div>
          </div>

          {/* Circular Progress */}
          <div className="relative w-40 h-40 mx-16 mb-2">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div className="text-2xl text-white font-semibold">{completionPercentage}%</div>
              <div style={{...FONTS.description}} className="text-xs !text-white text-center leading-tight">Completed Task</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-4 gap-2">
          <div className="flex items-center gap-3 bg-gray-200 border rounded-xl p-2 shadow-md">
            ...
            <div>
              <div style={{...FONTS.subParagraph}} className="text-xs !text-gray-800">New Queries</div>
          ...
          <div className="flex items-center gap-3 bg-gray-200 border rounded-xl p-2 shadow-md">
            ...
            <div>
              <div style={{...FONTS.subParagraph}}  className="text-xs !text-gray-800">Solved Queries</div>
          ...
          <div className="flex items-center gap-3 bg-gray-200 border rounded-xl p-2 shadow-md">
            ...
            <div>
              <div   style={{...FONTS.subParagraph}}  className="text-xs !text-gray-800">Unsolved Queries</div>

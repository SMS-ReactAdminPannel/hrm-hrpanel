...
const DashBoardSlideCard = () => {
  ...
  return (
    <div className="h-full">
      <div className="h-full flex flex-col justify-around rounded-lg shadow p-4   transition-all duration-300 ease-in-out ">
        {/* Header */}
        <div className="mb-2 ">
            ...
            <div className="grid grid-cols-2 gap-3 ">
              {current.stats.map((stat, i) => (
                <div key={i} className="flex gap-2 ">
                  <p className="bg-blue-100 rounded-lg  font-bold p-1 text-sm w-16 h-8 flex text-center justify-center">
                    {stat.value}
                  </p>

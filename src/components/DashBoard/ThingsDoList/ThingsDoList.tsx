    ...
    <div className="gap-3 grid p-4">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          {notificationCount > 0 && (
            <span className=" -top-1 -right-1 bg-red-800 text-white text-xs font-bold px-1.5 py-0.5 rounded-full">
              {notificationCount}
            </span>
          )}
        </div>
      ...
      {/* Scrollable List */}
      <div className="space-y-4 overflow-y-auto max-h-[300px] pr-1 scrollbar-hide">
        {queries.map((q, idx) => (
          <div
            key={idx}

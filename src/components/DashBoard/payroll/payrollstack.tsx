...
const PayrollStack: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-9 gap-2 mt-1 w-full">
      ...
      <div className="col-span-6 bg-white rounded-xl border border-white shadow-sm p-4 backdrop-blur bg-opacity-10 backdrop-saturate-100">
        <h2 className="text-2xl font-bold text-gary-900 mb-4">Transaction History</h2>

        {/* Table Headers */}
        <div className="grid grid-cols-4 font-bold text-sm text-black-800 border-b pb-2 mb-2">
          <div>Name</div>
          <div>Date - Time</div>
          <div>Amount</div>
          <div >Action</div>
  ...
  <div className="flex justify-between items-center  mb-6">
    ...
    <button className="text-sm font-bold text-white hover:underline">View Report</button>
  </div>

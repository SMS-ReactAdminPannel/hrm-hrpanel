  ...
  return (
    <div className="bg-[#eff4f5] w-full max-w-md rounded-lg p-4 pt-5 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium !text-gray-500 mb-1"style={{...FONTS.cardSubHeader}}>{title}</p>
          <p className={`text-5xl font-semibold ${textColor} mt-3`}>{value}</p>
          <p className="text-xs !text-gray-400 mt-5"style={{...FONTS.paragraph}}>{subtitle}</p>
        </div>

...
const EmployeeShiftTable: React.FC<EmployeeShiftTableProps> = ({
  ...
  return (
    <div className="flex-1 overflow-hidden mt-6">
      <div className="h-full overflow-auto rounded-md scrollbar-hide">
        <table className="w-full">
          <thead className="bg-[#5e59a9]/70 backdrop-blur-sm">
            <tr>
              <th className="px-4 lg:px-6 py-3 text-left text-sm font-medium text-white min-w-[200px] sticky left-0 bg-[#5e59a9] backdrop-blur-sm border-white/20 z-20">
                Employee
              </th>
              ...
              <th className="px-4 lg:px-6 py-3 text-center text-sm font-medium text-white min-w-[120px] sticky right-0 bg-[#5e59a9] border-white/20">
                Actions
              </th>
            </tr>
          </thead>
                  ...
                  <React.Fragment key={groupKey}>
                    {groupBy && (
                      <tr className="hover:bg-gray-900/70">
                        <td
                          colSpan={1}
                          className="px-4 lg:px-6 py-3 font-semibold text-gray-900 bg-gray-50/80 sticky left-0 border-gray-200/50 z-10"
                        >
                          {getGroupHeader(groupKey)}
                        </td>
                        <td
                          colSpan={9}
                          className="px-4 lg:px-6 py-3 font-semibold text-gray-900 bg-gray-50/80"
                        ></td>
                      </tr>
                    )}
                    ...
                    {employeesInGroup.map((employee) => (
                      <tr
                        key={employee.id}
                        className="group hover:bg-gray-100 hover:backdrop-blur-sm transition-colors duration-200"
                      >
                        <td className="px-2 lg:px-4 py-2 sticky left-0 bg-white group-hover:bg-gray-100 backdrop-blur border-gray-200/50 z-10">
                        ...
                        <td
                          className="px-4 lg:px-6 py-4 text-sm !text-gray-900 whitespace-nowrap"
                        ...
                        <td className="px-4 lg:px-6 py-4 sticky right-0 bg-white group-hover:bg-gray-100 backdrop-blur">

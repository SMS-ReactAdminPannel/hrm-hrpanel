                ...
                <React.Fragment key={groupKey}>
                  ...
                  {groupEmployees.map((employee) => (
                    <tr key={employee.id}>
                      <td className="px-4 lg:px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div>
                            ...
                            <div className="text-sm text-gray-500" style={{...FONTS.tableBody}}>{employee.employeeId}</div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 lg:px-6 py-4 whitespace-nowrap sticky right-0 bg-[#eff4f5]" style={{...FONTS.tableBody}}>

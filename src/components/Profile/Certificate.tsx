      ...
      <div className="flex items-center gap-3 mb-1 relative justify-between 
       bg-[#006666]/10 rounded-full transition-all duration-300 ">
        ...
        <button
          ...
          className="px-3 py-1 hover:text-blue-300  rounded-lg text-sm flex items-center gap-1
          px-1 py-1 bg-[#006666] hover:bg-[#008080] !text-white rounded-lg text-sm transition-colors duration-200 flex items-center gap-1"
          style={{ ...FONTS.button }}
        >
          <Plus size={16} />
      ...
      <div className=" overflow-auto h-[80%] scrollbar-hide ">
        ...
        certificates.map((certificate) => (
          ...
          className={`p-2  relative ${
            ...
            : "border-gray-500 bg-white/5 hover:bg-gray-300 shadow-2xl"
          } backdrop-blur-sm`}
          >
          ...
          <div className="  ">
           ...
           <div className=" flex justify-end gap-3">
            ...
            {/* The left-to-right line is removed here */}

          ...
          <div className="text-sm  grid grid-cols-2 gap-3 ">
            ...
            <p className="flex items-center">
              ...
              <input
                ...
                type="text"
                className="placeholder-black bg-transparent rounded-xl ml-1 outline-none w-full"
            ...
            <p className="flex items-center" >
              ...
              <input
                name="primaryPhone"
                type="tel"
                className="placeholder-black bg-transparent rounded-xl ml- outline-none w-full"

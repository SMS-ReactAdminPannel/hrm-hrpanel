  ...
  <div className="flex flex-row gap-4">
    <div className="flex-1 relative">
      ...
      <input
        ...
        className="w-100 md:w-96 pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006666] focus:border-transparent bg-white placeholder:text-black"
      />
    </div>

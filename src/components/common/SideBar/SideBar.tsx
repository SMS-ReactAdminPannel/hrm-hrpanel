...
//   return (
//     <div className={`w-full ${expanded && isOpen ?
//      "bg-white/15 backdrop-blur-lg rounded-2xl  border border-white/20" : " hover:backdrop-blur-md rounded-xl "}`}>
//       <button
//         onClick={() => setExpanded(!expanded)}
//         className={`flex items-center w-full py-2 mb-1 ${isOpen ? "justify-start gap-3 px-3 rounded-xl" : "justify-center px-0"}`}
...
//                   {expanded && isOpen && (
//                     <div className="ml-6 flex flex-col space-y-1">{children}</div>
//                   )}
//     </div>
//   )
// }

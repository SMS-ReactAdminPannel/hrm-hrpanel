    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg w-full max-w-2xl p-6 shadow-xl relative">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          <input name="fullName" placeholder="Full Name" value={formData.fullName} onChange={handleInputChange} className="border px-3 py-2 rounded" />
          <input name="phoneNumber" placeholder="Phone Number" value={formData.phoneNumber} onChange={handleInputChange} className="border px-3 py-2 rounded" />
          ...
          <select title="purposeOfVisit" required name="purposeOfVisit" value={formData.purposeOfVisit} onChange={handleInputChange} className="border px-3 py-2 rounded">
          ...
          <textarea name="remarks" placeholder="Remarks" value={formData.remarks} onChange={handleInputChange} className="border px-3 py-2 rounded col-span-2" />
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Check-In Time</label>
            <input title="chkIn" type="time" name="checkInTime" value={formData.checkInTime} onChange={handleInputChange} className="border px-3 py-2 rounded w-full" />
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Check-Out Time</label>
            <input title="chkOut" type="time" name="checkOutTime" value={formData.checkOutTime} onChange={handleInputChange} className="border px-3 py-2 rounded w-full" />
          </div>
          <div className="col-span-2">
            <label className="block text-sm font-semibold text-gray-700 mb-2">Submit Document</label>
            <input title="attachment" type="file" name="attachment" onChange={handleFileChange} className="border px-3 py-2 rounded w-full" />
          </div>
          <button className="bg-[#006666] text-white px-4 py-2 rounded col-span-2">Submit</button>
        </form>
      </div>
    </div>
  );
